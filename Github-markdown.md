## Github and its role in creating this website
...
Many components are necessary in order to create a website. On this particular (although very simple) website, you can see how the use of coding language, Application Programming Interfaces, and GitHub can be used in practice when creating and launching a website.  

  
Number of keystrokes: 5,001


## Bibliography

Beshero-Bondar, E. E., & Parker, R. J. (2017). *A GitHub Garage for a Digital Humanities Course.* In S. B. Fee, A. M. Holland-Minkley, & T. E. Lombardi (Eds.), *New Directions for Computing Education* (pp. 259–276). Springer International Publishing. https://doi.org/10.1007/978-3-319-54226-3_15

CSS Tutorial. (2025). Retrieved November 28, 2025, from https://www.w3schools.com/css/default.asp

HTML Tutorial. (2005). Retrieved November 28, 2025, from https://www.w3schools.com/html/default.asp

*What is an API? A Beginner’s Guide to APIs* | Postman. (2025). Retrieved November 28, 2025, from https://www.postman.com/what-is-an-api/
